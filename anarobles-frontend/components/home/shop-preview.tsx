...
import { ArrowRight, ShoppingBag, ChevronLeft, ChevronRight, Palette } from "lucide-react"
...
export function ShopPreview() {
  ...
  useEffect(() => {
    // TODO: replace with real API call when products are ready
    setFeaturedProducts([])
  }, [])
  ...
  return (
    <section className="section-lg relative bg-primary/10">
