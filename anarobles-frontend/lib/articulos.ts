...
- El color no funciona solo — siempre en relación con lo que lo rodea.`,
  },
  {
    ...
    tiempoLectura: 6,
    imagenDestacada: "/blog/blog-oleo-principiantes.png",
    imagenDestacadaAlt: "Paleta de óleos y pinceles sobre mesa de artista",
...
Cuando aceptás la lentitud como parte del proceso, el óleo deja de ser frustrante y se convierte en el medio más generoso que existe.`,
  },
  {
    ...
    tiempoLectura: 5,
    imagenDestacada: "/blog/blog-inspiracion-mediterranea.png",
    imagenDestacadaAlt: "Estudio de color mediterráneo en cuaderno de acuarela",
...
Eso es transportable a cualquier obra, en cualquier lugar.`,
  },
  {
    ...
    tiempoLectura: 7,
    imagenDestacada: "/blog/blog-pinceles-acuarela.png",
    imagenDestacadaAlt: "Colección de pinceles de acuarela sobre lino natural",
...
Cuidalos: nunca los dejes parados sobre la punta, lavalos con jabón neutro después de cada sesión, y secalos horizontalmente o con la punta hacia abajo.`,
  },
  {
    ...
    tiempoLectura: 5,
    imagenDestacada: "/blog/blog-boceto.png",
    imagenDestacadaAlt: "Cuaderno de bocetos abierto con estudios de figura y botánica",
...
Esa diferencia hace toda la obra.`,
  },
  {
    ...
    tiempoLectura: 9,
    imagenDestacada: "/blog/blog-temperatura-color.png",
    imagenDestacadaAlt: "Estudio de temperatura del color en acuarela — paletas cálidas y frías",
